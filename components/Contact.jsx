    ...
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-10 py-16 w-full '>
        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          {/* left */}
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-[#00000093]  rounded-xl p-4'>
              ...
              <div>
                ...
                <div className='flex items-center justify-between py-7'>
                  <a
                    ...
                    rel='noreferrer'
                  >
                    <div className='rounded-full shadow-md shadow-[#00000093] p-5 cursor-pointer hover:scale-110 ease-in duration-300'>
                      <FaLinkedinIn />
                    </div>
                  </a>
                  <a
          ...
          {/* right */}
          <div className='col-span-3 w-full h-auto shadow-xl shadow-[#00000093] rounded-xl lg:p-4'>
            <div className='p-4'>
              <form
        ...
        <div className='flex justify-center py-12'>
          <Link href='/'>
            <a>
              <div className='rounded-full shadow-lg shadow-[#00000093] p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
