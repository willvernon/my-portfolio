...
var Subverse = /** @class */ (function () {
    ...
    Subverse.prototype.removeSubverse = function (subverse) {
        this.subverses = this.subverses.filter(function (s) { return s !== subverse; });
    };
    Subverse.prototype.addParticle = function (particle) {
        this.particles.push(particle);
    };
    Subverse.prototype.removeParticle = function (particle) {
        this.particles = this.particles.filter(function (p) { return p !== particle; });
    };
    Subverse.prototype.getParticles = function () {
        return this.particles.concat(lodash_flatmap(this.subverses, function (subverse) { return subverse.getParticles(); }));
    };
    ...
    Subverse.prototype.removeParticleForce = function (particleForce) {
        this.particleForces = this.particleForces.filter(function (pf) { return pf !== particleForce; });
    };
    ...
    Subverse.prototype.applyForces = function (particle, particleForces) {
        var forces = particleForces.map(function (particleForce) { return particleForce(particle); });
    ...
    Subverse.prototype.tick = function () {
        ...
        this.subverses.forEach(function (subverse) { return subverse.tick(); });
    };
    return Subverse;
}());
...
})(exports.UniverseState || (exports.UniverseState = {}));
var Universe = /** @class */ (function (_super) {
    __extends(Universe, _super);
    function Universe(_a) {
        var _b = _a === void 0 ? {} : _a, bounds = _b.bounds, _c = _b.frameRate, frameRate = _c === void 0 ? 30 : _c, _d = _b.creationDuration, creationDuration = _d === void 0 ? 500 : _d, _e = _b.deathDuration, deathDuration = _e === void 0 ? 500 : _e, _f = _b.creationTimingFn, creationTimingFn = _f === void 0 ? timing.easeInQuad : _f, _g = _b.deathTimingFn, deathTimingFn = _g === void 0 ? timing.easeInQuad : _g, onStateChange = _b.onStateChange;
        var _this = _super.call(this, null, { bounds: bounds }) || this;
        _this.health = 0;
        ...
        _this.setState(exports.UniverseState.Creating);
        return _this;
    }
    ...
    Universe.prototype.die = function () {
        var _this = this;
        this.setState(exports.UniverseState.Dying);
    ...
    Universe.prototype.tick = function () {
        var _this = this;
        if (this.state === exports.UniverseState.Creating) {
            ...
            if (this.health === 1) {
                this.setState(exports.UniverseState.Created);
            }
        }
        else if (this.state === exports.UniverseState.Dying) {
            this.health = Math.max(this.health - this.deathRate, 0);
            this.getParticles().forEach(function (particle) {
                _this.applyDecay(particle);
            });
            if (this.health === 0) {
                this.setState(exports.UniverseState.Dead);
                this.resolveDeath();
            }
        }
...
var Particle = /** @class */ (function () {
    function Particle(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.radius, radius = _c === void 0 ? 1 : _c, _d = _b.friction, friction = _d === void 0 ? 10 : _d, _e = _b.mass, mass = _e === void 0 ? 100 : _e, _f = _b.position, position = _f === void 0 ? new Vector(0, 0) : _f, _g = _b.velocity, velocity = _g === void 0 ? new Vector(0, 0) : _g, _h = _b.color, color = _h === void 0 ? 'black' : _h, _j = _b.growthRate, growthRate = _j === void 0 ? .05 : _j, _k = _b.decayRate, decayRate = _k === void 0 ? .05 : _k;
...
var range = function (n) { return __spread(Array(n).keys()); };
...
var BrowserAnimator = /** @class */ (function () {
    function BrowserAnimator(callback, fps) {
        ...
        this.loop = function (timestamp) {
            ...
            if (seg > _this.frame) { // moved to next frame?
...
var CanvasRenderer = /** @class */ (function (_super) {
    ...
    CanvasRenderer.prototype.drawFrame = function (universe) {
        ...
        var particlesByColor = groupBy(particles, function (particle) { return particle.color; });
...
var Simulator = /** @class */ (function () {
    function Simulator(renderer, universe, _a) {
        var _this = this;
        if (universe === void 0) { universe = null; }
        var _b = (_a === void 0 ? {} : _a).frameRate, frameRate = _b === void 0 ? 30 : _b;
        this.id = null;
        this.start = function () {
...
var PixelManager = /** @class */ (function () {
    function PixelManager(options) {
        ...
        this.getParticleForce = function () { return function (particle) {
...
var Array2D = /** @class */ (function () {
    ...
    Array2D.prototype.updateWidth = function () {
        this.width = Math.min.apply(Math, __spread(this.array.map(function (row) { return row.length; })));
    };
    ...
    Array2D.prototype.slice = function (_a, _b) {
        var _c = __read(_a, 2), xMin = _c[0], xMax = _c[1];
        var _d = __read(_b, 2), yMin = _d[0], yMax = _d[1];
...
var createImageUniverse = function (_a) {
    var url = _a.url, maxParticles = _a.maxParticles, particleOptions = _a.particleOptions, scale = _a.scale, canvasDimensions = _a.canvasDimensions, creationTimingFn = _a.creationTimingFn, deathTimingFn = _a.deathTimingFn, creationDuration = _a.creationDuration, deathDuration = _a.deathDuration, onUniverseStateChange = _a.onUniverseStateChange;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, getImageData(url)];
                case 1:
                    image = _b.sent();
                    ...
                    while (selectedPixels < maxParticles && indexArray.length) {
                        ...
                        shouldCreateParticle = particleOptions.filter({ x: x, y: y, image: image });
                        if (shouldCreateParticle) {
                            subverse = universe.createSubverse();
                            pixelManager = new PixelManager({ pixelX: x, pixelY: y, scale: scale, imageHeight: image.getHeight(), imageWidth: image.getWidth(), canvasWidth: canvasDimensions.width, canvasHeight: canvasDimensions.height });
                            pixelManagers.push(pixelManager);
                            subverse.addParticleForce(pixelManager.getParticleForce());
                            color = particleOptions.color({ x: x, y: y, image: image });
                            radius = particleOptions.radius({ x: x, y: y, image: image });
                            friction = particleOptions.friction({ x: x, y: y, image: image });
                            mass = particleOptions.mass({ x: x, y: y, image: image });
                            position = particleOptions.initialPosition({ x: x, y: y, image: image, finalPosition: pixelManager.getPixelPosition(), canvasDimensions: canvasDimensions });
                            velocity = particleOptions.initialVelocity({ x: x, y: y, image: image });
                            subverse.addParticle(new Particle({ radius: radius, mass: mass, color: color, friction: friction, position: position, velocity: velocity }));
                            selectedPixels += 1;
                        }
                    }
                    return [2 /*return*/, { universe: universe, pixelManagers: pixelManagers }];
            }
        });
    });
};
...
var useTransientParticleForce = function (_a) {
    var universe = _a.universe, _b = _a.duration, duration = _b === void 0 ? 100 : _b;
    var _c = __read(React.useState(null), 2), particleForce = _c[0], setParticleForce = _c[1];
...
var defaultParticleOptions = {
    ...
    mass: function () { return 50; },
    color: function () { return 'white'; },
    friction: function () { return .15; },
    initialPosition: function (_a) {
        var finalPosition = _a.finalPosition;
        return finalPosition;
    },
    initialVelocity: function () { return new Vector(0, 0); }
};
var ParticleImage = function (_a) {
    var src = _a.src, _b = _a.height, height = _b === void 0 ? 400 : _b, _c = _a.width, width = _c === void 0 ? 400 : _c, _d = _a.scale, scale = _d === void 0 ? 1 : _d, _e = _a.maxParticles, maxParticles = _e === void 0 ? 5000 : _e, _f = _a.entropy, entropy = _f === void 0 ? 20 : _f, _g = _a.backgroundColor, backgroundColor = _g === void 0 ? '#222' : _g, _h = _a.particleOptions, particleOptions = _h === void 0 ? {} : _h, mouseMoveForce = _a.mouseMoveForce, touchMoveForce = _a.touchMoveForce, mouseDownForce = _a.mouseDownForce, _j = _a.mouseMoveForceDuration, mouseMoveForceDuration = _j === void 0 ? 100 : _j, _k = _a.touchMoveForceDuration, touchMoveForceDuration = _k === void 0 ? 100 : _k, _l = _a.mouseDownForceDuration, mouseDownForceDuration = _l === void 0 ? 100 : _l, creationTimingFn = _a.creationTimingFn, creationDuration = _a.creationDuration, deathTimingFn = _a.deathTimingFn, deathDuration = _a.deathDuration, onUniverseStateChange = _a.onUniverseStateChange, onImageStateChange = _a.onImageStateChange, _m = _a.style, style = _m === void 0 ? {} : _m, otherProps = __rest(_a, ["src", "height", "width", "scale", "maxParticles", "entropy", "backgroundColor", "particleOptions", "mouseMoveForce", "touchMoveForce", "mouseDownForce", "mouseMoveForceDuration", "touchMoveForceDuration", "mouseDownForceDuration", "creationTimingFn", "creationDuration", "deathTimingFn", "deathDuration", "onUniverseStateChange", "onImageStateChange", "style"]);
    var _o = __read(React.useState(), 2), canvas = _o[0], setCanvas = _o[1];
    var _p = __read(React.useState(), 2), universe = _p[0], setUniverse = _p[1];
    var simulatorRef = React.useRef();
    var entropyForceRef = React.useRef();
    var _q = __read(React.useState([]), 2), pixelManagers = _q[0], setPixelManagers = _q[1];
    ...
    React.useEffect(function () {
        if (canvas) {
            ...
            simulator_1.start();
            return function () { return simulator_1.stop(); };
        }
    }, [canvas]);
    React.useEffect(function () {
        var _a, _b;
        if (canvas) {
            ...
            Promise.all([setUp, death])
                .then(function (_a) {
                var _b = __read(_a, 1), _c = _b[0], universe = _c.universe, pixelManagers = _c.pixelManagers;
                var _d;
    ...
    var updateScale = React.useCallback(lodash_throttle(function (scale) {
        pixelManagers.forEach(function (pixelManager) {
            pixelManager.setScale(scale);
        });
    }, 50), [pixelManagers]);
    var updateWidth = React.useCallback(lodash_throttle(function (width) {
        pixelManagers.forEach(function (pixelManager) {
            pixelManager.setCanvasWidth(width);
        });
    }, 50), [pixelManagers]);
    var updateHeight = React.useCallback(lodash_throttle(function (height) {
        pixelManagers.forEach(function (pixelManager) {
    ...
    var _r = __read(useTransientParticleForce({ universe: universe, duration: mouseMoveForceDuration }), 2), mouseMoveParticleForce = _r[0], setMouseMoveParticleForce = _r[1];
    var _s = __read(useTransientParticleForce({ universe: universe, duration: touchMoveForceDuration }), 2), touchMoveParticleForce = _s[0], setTouchMoveParticleForce = _s[1];
    var _t = __read(useTransientParticleForce({ universe: universe, duration: mouseDownForceDuration }), 2), mouseDownParticleForce = _t[0], setMouseDownParticleForce = _t[1];
    var handleMouseMove = function (e) {
        var _a, _b;
        if (mouseMoveForce) {
            var position_1 = getMousePosition(e);
            setMouseMoveParticleForce(function () { return mouseMoveForce(position_1.x, position_1.y); });
        }
    ...
    var handleTouchMove = function (e) {
        ...
        if (touchMoveForce) {
            ...
            setTouchMoveParticleForce(function () { return touchMoveForce(position_2.x, position_2.y); });
        }
    ...
    var handleMouseDown = function (e) {
        ...
        if (mouseDownForce) {
            ...
            setMouseDownParticleForce(function () { return mouseDownForce(position_3.x, position_3.y); });
        }
        (_b = (_a = otherProps).onMouseDown) === null || _b === void 0 ? void 0 : _b.call(_a, e);
    };
    return (React__default.createElement("canvas", __assign({}, otherProps, { onMouseMove: handleMouseMove, onTouchMove: handleTouchMove, onMouseDown: handleMouseDown, height: height, width: width, style: __assign({ backgroundColor: backgroundColor, touchAction: 'none' }, style), ref: function (c) {
            var _a;
...
exports.useTransientParticleForce = useTransientParticleForce;
exports.default = ParticleImage;
exports.BrowserAnimator = BrowserAnimator;
exports.getMousePosition = getMousePosition;
exports.getTouchPosition = getTouchPosition;
exports.Universe = Universe;
exports.Subverse = Subverse;
