...
var useTransientParticleForce = function (_a) {
    ...
    var _c = __read(useState(null), 2), particleForce = _c[0], setParticleForce = _c[1];
    useEffect(function () {
...
var ParticleImage = function (_a) {
    ...
    var _o = __read(useState(), 2), canvas = _o[0], setCanvas = _o[1];
    var _p = __read(useState(), 2), universe = _p[0], setUniverse = _p[1];
    var simulatorRef = useRef();
    var entropyForceRef = useRef();
    var _q = __read(useState([]), 2), pixelManagers = _q[0], setPixelManagers = _q[1];
    ...
    return (React.createElement("canvas", __assign({}, otherProps, { onMouseMove: handleMouseMove, onTouchMove: handleTouchMove, onMouseDown: handleMouseDown, height: height, width: width, style: __assign({ backgroundColor: backgroundColor, touchAction: 'none' }, style), ref: function (c) {
            var _a;
...
export { useTransientParticleForce, BrowserAnimator, getMousePosition, getTouchPosition, Universe, UniverseState, Subverse, Particle, Vector, Renderer, CanvasRenderer, Simulator, PixelManager, Array2D, forces, timing$1 as timing };
